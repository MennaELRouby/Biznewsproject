...
{
	try{
	$sql="INSERT INTO `news`(`publish_date`, `title`, `content`, `author`, `active`, `img`, `id_category`) VALUES (?,?,?,?,?,?,?)";
	...
	//$image_name="/img/media.jpg";
	$stmt=$conn->prepare($sql);
	$stmt->execute([$pubdate, $title, $content, $author, $active, $image_name, $cat]);
									...
									<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="date" id="News-date" required="required" class="form-control " name="pubdate">
											</div>
										</div>
										<div class="item form-group">
