...
if(isset($_GET["id"]))
{
	...
	{
		echo "Can't dispaly Category Data:" .$e->getMessage();
	}
}
elseif($_SERVER["REQUEST_METHOD"] === "POST")
{
	...
	$sql="UPDATE `category` SET `catname`=? WHERE id=?";
	$stmt = $conn->prepare($sql);
									...
									<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="add-category" required="required" class="form-control " name="catname" value="<?php echo $catname; ?>">
											</div>
										</div>
