                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
                        ...
                        <tr>
                          ...
                          <td><?php echo $a; ?></td>
                          <td><a href="editnews.php?id=<?php echo $id; ?>" > <img src="./img/edit.png" alt="Edit"></a></td>
                          <td><a href="deletenews.php?id=<?php echo $id; ?>" onclick="return confirm('Are you sure you want to delete?')"> <img src="./img/delete.png" alt="Delete"></a></td>
                        </tr>
                        <?php
                          } }else{  
                            echo "No data found";
